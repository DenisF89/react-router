...
const Stars = ({value})=>{
        ...
        return(
            ...
            <span   key={i}
                    className={"rating "+(i < filled ?"yellow":"")}>    {/* se l'indice minore delle stelle piene coloro di giallo */}
                        {i < filled ? "★" : "☆"}                       {/* se l'indice minore delle stelle piene stampo stella piena, altrimenti stella vuota */}
            </span>
            )
        ) 
